...
const TrainingPage: React.FC<TrainingPageProps> = ({ setPage }) => {
    ...
    return (
        <div className="pt-20 sm:pt-24 pb-8 sm:pb-12">
            <header className="relative py-12 sm:py-16 md:py-20 text-center text-white overflow-hidden">
                ...
                <div className="relative z-10 container mx-auto px-4">
                    <AnimatedSection>
                        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold">Shield Agency Training Academy</h1>
                        <p className="text-base sm:text-lg md:text-xl mt-2 text-accent-gold">Creating the Next Generation of Elite Security Professionals.</p>
                    </AnimatedSection>
                </div>
            </header>
            ...
            <div className="container mx-auto px-4">
                    ...
                    <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
                        <AnimatedSection>
                         ...
                         <AnimatedSection delay="delay-300">
                             <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 text-highlight-blue">Beyond the Standard</h2>
                ...
                <section className="py-12 sm:py-16">
                     <AnimatedSection>
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-8 sm:mb-12">Course <span className="text-highlight-blue">Modules</span></h2>
                    </AnimatedSection>
                 ...
                 <AnimatedSection>
                    <section className="text-center py-12 sm:py-16 my-6 sm:my-8 bg-glass-bg border border-white/10 rounded-lg px-4">
                        <h2 className="text-2xl sm:text-3xl font-bold mb-4">Ready to Join the Elite?</h2>
                        <p className="max-w-2xl mx-auto text-gray-300 mb-6 sm:mb-8 text-sm sm:text-base">Take the first step towards a rewarding career in high-level security. We are looking for dedicated individuals with integrity and a commitment to excellence.</p>
